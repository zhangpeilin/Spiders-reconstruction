...
public class SpiderOnNASThread extends CommonThread {
    ...
    public static void dobusiness(int offset) throws IOException {
        ...
        data.setUrl("http://www.ariess.info:5000/mo/sharing/webapi/entry.cgi/SYNO.Foto.Browse.Item");
        data.setHeader(headers);

        data.setParams(String.format("api=SYNO.Foto.Browse.Item&method=list&version=1&additional=[\"thumbnail\",\"resolution\",\"orientation\",\"video_convert\",\"video_meta\",\"provider_user_id\"]&offset=%1$s&limit=100&sort_by=\"item_type\"&sort_direction=\"desc\"&passphrase=\"pKQcitKUk\"", offset));
