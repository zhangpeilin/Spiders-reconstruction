...
public class StrUtil {
    ...
    public static void main(String[] args){
        String strA = "[Shinsei Lolishota (Ema, kozi)] Kyou kara Seiyoku Shori Iin. [Chinese] [不可视汉化] [Digital].zip";
        String strB = "(Shinshun Kemoket) [Santama (Gaku)] Ookami Goroshi no Ichizoku [Chinese] [悬赏大厅x新桥月白日语社]";
