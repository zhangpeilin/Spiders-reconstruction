...
public class CommonStringUtil {
    ...
    public static double simulate(String str1, String str2) {
    ...
    public static int simulatev2(String str1, String str2){
    ...
    public static double stickCheck(String strA, String strB) {
        double similarDegree = SimilarDegree(strA, strB);
        double similarityRatio = similarityRatio(strA, strB);
        int compare = compare(strA, strB);
        if (compare < 5) {
            return Math.min(similarDegree, similarityRatio);
        } else {
            return 0;
        }
    }
